...
${MYSQL} -u root -ptrinity characters < ${REPO}/sql/characters_ai_playerbot_real_names.sql
${MYSQL} -u root -ptrinity characters < ${REPO}/sql/ai_playerbot_guild_names.sql
