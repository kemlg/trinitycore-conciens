...
sed -i 's;DataDir.=....;DataDir='"${INSTALL}"'/data;' worldserver.conf
cd /tmp/
...
mysql -u root -ptrinity world < /tmp/TDB_full_world_335.60_2015_11_07.sql
...
cd -
screen -S authserver -d -m authserver
